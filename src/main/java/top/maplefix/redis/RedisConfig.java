...
public class RedisConfig extends CachingConfigurerSupport {
    ...
    public CacheManager cacheManager(RedisConnectionFactory redisConnectionFactory) {
        ...
        RedisCacheConfiguration defaultCacheConfig = RedisCacheConfiguration.defaultCacheConfig()
                ...
                .serializeValuesWith(MyRedisCacheManager.FAST_JSON_PAIR);
    ...
    public RedisTemplate<Object, Object> redisTemplate(RedisConnectionFactory connectionFactory) {
        ...
        // set key serializer
        StringRedisSerializer serializer = MyRedisCacheManager.STRING_REDIS_SERIALIZER;
        template.setKeySerializer(serializer);
        template.setHashKeySerializer(serializer);

        GenericFastJsonRedisSerializer fastSerializer = MyRedisCacheManager.FAST_JSON_REDIS_SERIALIZER;
