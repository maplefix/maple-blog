...
public class QiNiuServiceImpl implements QiNiuService {
    ...
    public int updateQiNiuConfig(QiNiuConfig qiNiuConfig) {
        ...
        config.setUpdateDate(DateUtils.getTime());
        ...
        while (fileListIterator.hasNext()) {
            ...
            if (Objects.nonNull(items)) {
                ...
                for (FileInfo item : items) {
                    ...
                    qiNiuContent.setCreateDate(DateUtils.parseDateToStr(DateUtils.YYYY_MM_DD_HH_MM_SS,convertUnixTime(item.putTime + "")));
